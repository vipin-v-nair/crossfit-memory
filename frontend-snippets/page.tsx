...
//
// Replace the scaffolded page.tsx with this. Sleek single-screen layout:
//   - Left:  CopilotKit chat sidebar
//   - Right: Live "Memory Bank" panel that polls /memories and groups by topic
//
// The CopilotKit runtime is wired in app/api/copilotkit/route.ts (default
// from scaffold). Make sure that route points at http://localhost:8000/agent.
...
function MemoryPanel() {
  ...
  useEffect(() => {
    ...
    fetchMemories();
    const id = setInterval(fetchMemories, 5000); // poll every 5s
